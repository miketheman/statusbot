...
def test_status_good(sample_facebook_status_good_response):
    responses.add(responses.GET, 'https://www.facebook.com/platform/api-status/',
                  json=sample_facebook_status_good_response)
...
def test_status_not_good(sample_facebook_status_bad_response):
    responses.add(responses.GET, 'https://www.facebook.com/platform/api-status/',
                  json=sample_facebook_status_bad_response)

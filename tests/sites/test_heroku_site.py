...
def test_status_good(sample_heroku_status_good_response):
    responses.add(responses.GET, "https://status-api.heroku.com/api/ui/systems", json=sample_heroku_status_good_response)
...
def test_status_not_good(sample_heroku_status_bad_response):
    responses.add(responses.GET, "https://status-api.heroku.com/api/ui/systems", json=sample_heroku_status_bad_response)
